...
# Views based off static templates
alerts_view = TemplateView.as_view(template_name='broker_tom/alerts.html')
objects_view = TemplateView.as_view(template_name='broker_tom/objects.html')
