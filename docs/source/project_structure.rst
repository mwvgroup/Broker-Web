...
- Ensure a minimum test coverage of the django backend 60%
...
which is formalized below. No accessibility requirements are formally imposed
during the development process, only on the final delivered product.
